<li class="nav-item dropdown custom-dropdown d-md-inline-flex d-flex">
  <a class="navbar-nav-link rounded px-2" href="#" data-bs-toggle="dropdown" aria-expanded="false">
    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24" class="theme-icon-active opacity-50"><use href="#sun-fill"></use></svg>
  </a>
  <ul class="dropdown-menu dropdown-menu-end p-xl-2 shadow rounded-2" aria-labelledby="bd-theme" style="width: 170px; top: 50px;">
...
<style>
  /* Стили для открытия вверх для кастомного dropdown */
  ...
  /* На экранах <=700px всегда открывать вверх для кастомного dropdown */
