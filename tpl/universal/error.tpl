...
<main class="container-fluid px-0 error-page">
    ...
    <aside class="px-xl-5 px-4 auth-aside" data-bs-theme="none">
        <div class="row">
            ...
            <div class="col-12">
                <!-- FIXED: Replaced ILLEGAL <li> with <div> -->
                <div class="nav-item dropdown px-md-2 d-md-inline-flex">
    ...
    <div class="px-xl-5 px-4 auth-body">
        <form>
            <div class="row g-3 li_animate">

                <div class="col-12">
                    <img src="../system/assets/svg/large.svg"
                         alt="large logo"
                         class="w-100"
                         onclick="window.location.href='{$currentDir}'"
                         style="cursor:pointer;">
                </div>

                <div class="col-12 mt-4">
                    <h3>{if !empty($error_title)}{$error_title}{else}Системная ошибка{/if}</h3>
                    <p>{$error_message}</p>
                </div>

                <div class="col-12 mt-4">
                    <a class="btn btn-lg w-100 btn-primary text-uppercase mb-2"
                       href="/admin" title="">
                        На главную
                    </a>
                </div>
                ...
                <div class="col-12 mt-4">
                    ...
                    <div class="tagcloud mb-4">
                        <a href="#" class="tag-link rounded-pill border px-3" style="--hover-color: var(--theme-color1)">
                            Тех. поддержка
                        </a>
                    </div>
                </div>
    ...
    <footer class="px-xl-5 px-4">
        <p class="mb-0 text-muted">© 2023 
            <a href="https://megadigital.space/" target="_blank" title="Mega Digital Space">
                Mega Digital Space
            </a>, 
            All Rights Reserved.
        </p>
