    ...
    <div class="col-12">
        <form method="POST" enctype="multipart/form-data">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="title" id="title" class="form-control mt-2 mb-2" placeholder="Заголовок объявления">
                    ...
                    <div class="row">
                        {foreach from=$fields item=field key=index}
                            <div class="col-12 col-md-4 mt-3">
                                <label>{$lang.fields.ads[$index]}</label>
                ...
                <div class="col-3">
                    <button type="submit" name="{if $access['modules.update']}addad{else}addform{/if}" class="btn btn-success mt-2 mb-2" id="submitButton">Добавить</button>
                </div>
                <input type="hidden" name="folder" value="ads">
