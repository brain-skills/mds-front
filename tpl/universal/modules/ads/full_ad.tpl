<div class="card py-3 px-3 bg-blurred">
    <div class="row">
        ...
        {include file="../../extensions/page-qr-sharing.tpl" module="ads"}

        <div class="col-12 mt-3">
            <h5>Комментарии:</h5>
            {include file='universal/comments.tpl' comments=$comments ads=$ads}
        </div>
    </div>
</div>