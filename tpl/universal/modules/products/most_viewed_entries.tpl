{if isset($products_most_viewed_entries) && $products_most_viewed_entries}
    <div class="row mt-3">
        <div class="col-12">
            <h4 class="mb-2">Самые просматриваемые товары</h4>
            <!-- Вывод самых просматриваемых новостей -->
            <div class="swiper-container mb-5" id="mostViewedProductsSwiper">
                <div class="swiper-wrapper">
                    {foreach $mostViewedProducts as $products}
