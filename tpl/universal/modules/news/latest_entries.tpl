{if isset($news_latest_entries) && $news_latest_entries}
    <div class="container px-lg-3 news-margin rounded-pill">
        <div class="card-body rounded-pill">
            <div class="swiper">
                <div class="swiper-container mySwiper1">
                    <div class="swiper-wrapper"> {foreach $latestNews as $news} <div class="swiper-slide rounded-pill">
                            ...
                            <div class="title rounded-bottom-3">
                                <h6>
                                    <a href="/news/{$news.alt_name}?lang={$news.language}">{$news.title|truncate:25:"..."}</a>
                                </h6>
