{if isset($ads_popular_entries) && $ads_popular_entries}
    <div class="row mt-3">
        <div class="col-12">
            <h4 class="mb-2">Популярные объявления</h4>
            <!-- Вывод популярных новостей -->
            <div class="swiper-container" id="popularAdsSwiper">
                <div class="swiper-wrapper">
                    {foreach $popularAds as $ads}
