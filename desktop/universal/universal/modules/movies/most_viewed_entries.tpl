{if isset($movies_most_viewed_entries) && $movies_most_viewed_entries}
    <div class="row mt-3">
        <div class="col-12">
            <h4 class="mb-2">Самые просматриваемые фильмы</h4>
            <!-- Вывод самых просматриваемых новостей -->
            <div class="swiper-container mb-5" id="mostViewedMoviesSwiper">
                <div class="swiper-wrapper">
                    {foreach $mostViewedMovies as $movies}
