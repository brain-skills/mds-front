<li class="nav-item d-none d-md-inline-flex">
    <a class="gray-6" href="#" role="button" id="notificationIcon" title="notification">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="mb-0 title-font">Уведомления</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"></button>
            </div>
            <div class="modal-body">
                <ul class="list-unstyled custom_scroll ps-2" style="height: 400px; overflow-y: auto;">
                    <li class="pe-2">
				...
				<li class="pe-2">
					<a class="d-flex p-lg-3 p-2 rounded-3 align-items-start" href="javascript:void(0);">
						<img class="avatar sm rounded-circle" src="{$stheme}/images/xs/avatar4.jpg" alt="avatar">
						<div class="flex-fill ms-3">
				...
				<li class="pe-2">
					<div class="d-flex p-lg-3 p-2 rounded-3">
						<img class="avatar sm rounded-circle" src="{$stheme}/images/xs/avatar1.jpg" alt="avatar">
						<div class="flex-fill ms-3">
