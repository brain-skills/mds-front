<h5 class="text-white mt-3">Форма обратной связи:</h5>
...
<form method="post">
    ...
    <div class="row">
        <div class="col-12 col-md-3 mb-2">
            <label class="text-white col-form-label">Имя:</label>
        ...
        <div class="col-12 col-md-3 mb-2">
            <label class="text-white col-form-label">Телефон:</label>
            <fieldset class="form-icon-group left-icon position-relative">
        ...
        <div class="col-12 col-md-3 mb-2">
            <label class="text-white col-form-label">Электронная почта:</label>
            <fieldset class="form-icon-group left-icon position-relative">
        ...
        <div class="col-12 col-md-3 mb-2">
            <label class="text-white col-form-label">Тема обращения:</label>
            <fieldset class="form-icon-group left-icon position-relative">
        ...
        <div class="col-12 col-md-12 mb-2">
            <label class="text-white col-form-label">Сообщение:</label>
        ...
        <div class="col-md-12 mb-3">
            <div class="form-group">
                <label for="text-white security_answer">Вопрос: {$security_question_text}</label>
    ...
    <button type="submit" class="btn btn-success text-white w-100 mt-3" name="submit_feedback">Отправить</button>
</form>